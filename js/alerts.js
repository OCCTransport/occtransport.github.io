const ALERT = {
  active: true,
  text: 'Wednesday, Sep 9: Expect Severe Delays. Runs may be canceled without notice. Refer to SPOT or ETA Transit Announcements.      Rosh Hashanah Break (9/11-9/13): OCCT is running an Alternate reduced schedule on all routes. Regular weekday and weekend service resumes Monday, 9/14. Late Nite service will not operate.',
